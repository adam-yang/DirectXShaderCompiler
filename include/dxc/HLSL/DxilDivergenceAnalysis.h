//===- llvm/Analysis/DxilDivergenceAnalysis.h - Divergence Analysis -*- C++ -*-===//
//
...
namespace llvm {
class Value;
class DxilDivergenceAnalysis : public FunctionPass {
public:
  static char ID;

  DxilDivergenceAnalysis() : FunctionPass(ID) {
    initializeDxilDivergenceAnalysisPass(*PassRegistry::getPassRegistry());
  }
